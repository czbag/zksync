...
def get_module():
    result = questionary.select(
        ...
        choices=[
            ...
            Choice("47) Create gnosis safe", create_safe),
            Choice("48) Swap tokens to ETH", swap_tokens),
            Choice("49) MultiSwap", swap_multiswap),
            Choice("50) Use custom routes", custom_routes),
            Choice("51) MultiApprove", multi_approve),
            Choice("52) Deploy contract and mint token", deploy_contract_zksync),
